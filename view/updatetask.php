...
<form method="post">
  <div class="form-group">
    ...
    <input type="hidden" name="task_id" class="form-control"  value="<?php echo $task['task_id'] ?>" >
		<textarea name="task_descr" id="texte"  ><?php echo $task['task_descr'] ?></textarea>
    
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">deadline</label>
    <input type="date" name="task_end" class="form-control"  value="<?php echo $task['task_end'] ?>">
  </div>
